...
namespace CinemaSyncServer.DAL
{
    public class DBservices
    {
        ...
        //--------------------------------------------------------------------------------------------------
        // This method clears the primary flag of a specific inventory count
        //--------------------------------------------------------------------------------------------------
        public int UnsetInventoryCountPrimary(int countId, int branchCode)
        {
            SqlConnection con = null;
            SqlCommand cmd;
            ...
            paramDic.Add("@CountId", countId);
            paramDic.Add("@BranchCode", branchCode);
            cmd = CreateCommandWithStoredProcedureGeneral("SP_InventoryCounts_UnsetPrimary", con, paramDic);
        ...
        //--------------------------------------------------------------------------------------------------
        // This method deletes an inventory count and all of its product items
        //--------------------------------------------------------------------------------------------------
        public int DeleteInventoryCount(int countId)
        {
            SqlConnection con = null;
            SqlCommand cmd;
            ...
            Dictionary<string, object> paramDic = new Dictionary<string, object>();
            paramDic.Add("@CountId", countId);
            cmd = CreateCommandWithStoredProcedureGeneral("SP_InventoryCounts_Delete", con, paramDic);
        ...
        //--------------------------------------------------------------------------------------------------
        // This method inserts or updates a single product stock entry for an existing inventory count
        //--------------------------------------------------------------------------------------------------
        public int UpsertInventoryCountItem(int countId, int productId, int stockAtCount)
        {
            SqlConnection con = null;
            SqlCommand cmd;
            ...
            paramDic.Add("@ProductId", productId);
            paramDic.Add("@StockAtCount", stockAtCount);
            cmd = CreateCommandWithStoredProcedureGeneral("SP_InventoryCountItems_Upsert", con, paramDic);
